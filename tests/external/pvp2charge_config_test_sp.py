...
from saml2.entity_category.at_egov_pvp2 import PVP2CHARGE
...
CONFIG = {
    ...
    "service": {
        "sp": {
            ...
            # The assertion is created for the proxy, so you must allow that the assertion is not
            # designated for this SP.
