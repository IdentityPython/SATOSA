...
MAP = {
    ...
    'fro': {
        ...
        DEF+'swissEduPersonUniqueID': 'swissEduPersonUniqueID',
        DEF+'swissEduPersonDateOfBirth': 'swissEduPersonDateOfBirth',
        DEF+'swissEduPersonGender': 'swissEduPersonGender',
        DEF+'swissEduPersonHomeOrganization': 'swissEduPersonHomeOrganization',
        DEF+'swissEduPersonHomeOrganizationType': 'swissEduPersonHomeOrganizationType',
        DEF+'swissEduPersonStudyBranch1': 'swissEduPersonStudyBranch1',
        DEF+'swissEduPersonStudyBranch2': 'swissEduPersonStudyBranch2',
        DEF+'swissEduPersonStudyBranch3': 'swissEduPersonStudyBranch3',
        DEF+'swissEduPersonStudyLevel': 'swissEduPersonStudyLevel',
        DEF+'swissEduPersonStaffCategory': 'swissEduPersonStaffCategory',
        DEF+'swissEduPersonMatriculationNumber': 'swissEduPersonMatriculationNumber',
        DEF+'swissEduPersonCardUID': 'swissEduPersonCardUID',
        DEF+'swissEduID': 'swissEduID',
        DEF+'swissLibraryPersonAffiliation': 'swissLibraryPersonAffiliation',
        DEF+'swissLibraryPersonResidence': 'swissLibraryPersonResidence',
    },
    'to': {
        'aRecord': DEF+'aRecord',
        ...
        'swissEduPersonUniqueID': DEF+'swissEduPersonUniqueID',
        'swissEduPersonDateOfBirth': DEF+'swissEduPersonDateOfBirth',
        'swissEduPersonGender': DEF+'swissEduPersonGender',
        'swissEduPersonHomeOrganization': DEF+'swissEduPersonHomeOrganization',
        'swissEduPersonHomeOrganizationType': DEF+'swissEduPersonHomeOrganizationType',
        'swissEduPersonStudyBranch1': DEF+'swissEduPersonStudyBranch1',
        'swissEduPersonStudyBranch2': DEF+'swissEduPersonStudyBranch2',
        'swissEduPersonStudyBranch3': DEF+'swissEduPersonStudyBranch3',
        'swissEduPersonStudyLevel': DEF+'swissEduPersonStudyLevel',
        'swissEduPersonStaffCategory': DEF+'swissEduPersonStaffCategory',
        'swissEduPersonMatriculationNumber': DEF+'swissEduPersonMatriculationNumber',
        'swissEduPersonCardUID': DEF+'swissEduPersonCardUID',
        'swissEduID': DEF+'swissEduID',
        'swissLibraryPersonAffiliation': DEF+'swissLibraryPersonAffiliation',
        'swissLibraryPersonResidence': DEF+'swissLibraryPersonResidence',
    }
}
