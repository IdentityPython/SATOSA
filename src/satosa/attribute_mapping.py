...
class AttributeMapper(object):
    ...
    def to_internal(self, attribute_profile, external_dict):
        ...
        for internal_attribute_name, mapping in self.from_internal_attributes.items():
            ...
            attribute_values = self._collate_attribute_values_by_priority_order(
                    external_attribute_name, external_dict, attribute_profile)
    ...
    def _collate_attribute_values_by_priority_order(
            self, attribute_names, data, attribute_profile=None):
        result = []
        for attr_name in attribute_names:
            attr_val = self._get_nested_attribute_value(
                attr_name, data, attribute_profile)
    ...
    def _get_nested_attribute_value(
            self, nested_key, data, attribute_profile=None):
        if (attribute_profile == 'openid'):
